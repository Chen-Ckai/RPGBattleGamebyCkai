...
int SHOP(int p){
    ...
    switch(item_type){
        case 1:
            ...
            for(int i = 0; i < 10; i++){
                if(!players[p].owned_weapons[i] && players[p].gold >= WColl[i].cost){ //Only show weapons that the player can afford and doesn't already own
        ...
        case 2:
            ...
            for(int i = 0; i < 10; i++){
                if(!players[p].owned_defences[i] && players[p].gold >= DefColl[i].cost){ //Only show defences that the player can afford and doesn't already own
